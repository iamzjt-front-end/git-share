          ...
          >
            ...
            <div className="w-24 shrink-0 flex items-center justify-center relative">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <div
                  className={`w-6 h-6 rounded-full bg-black border-[3px] shadow-lg transition-all duration-700 ${
                    commit.type === "feat"
                      ? "border-blue-500 shadow-blue-500/40 scale-110"
                      : commit.type === "fix"
                        ? "border-red-500 shadow-red-500/40 scale-110"
